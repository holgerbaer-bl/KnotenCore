...
| `src/vm/mod.rs` | **Virtual Machine (AOT)** — *[New]* Dedicated Ahead-of-Time Bytecode compiler scaling complex loops past AST limits. Incorporates a unified Stack Machine / ALU, global HashMaps, and Sandboxed OS interaction (`read_file`, `str_split`, `arr_contains`). |

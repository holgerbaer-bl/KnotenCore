...
fn test_version_assertion_sprint340() {
    assert_eq!(KNC_PROTOCOL_VERSION, "v2.24.1");
    ...
    assert!(resp.contains("\"protocol_version\":\"v2.24.1\""));
}
...
fn test_benchmark_engine_direct_api() {
    ...
    assert_eq!(report.protocol_version, "v2.24.1");
    ...
    assert!(json_str.contains("\"protocol_version\":\"v2.24.1\""));
